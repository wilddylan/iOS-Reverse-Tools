...
#import "CompanyForgetPasswordDelegate.h"
#import "UINavigationControllerDelegate.h"

@class NSString, UIButton, UIImageView, UILabel, UITextField;

@interface LoginViewController : BaseNavViewController <UINavigationControllerDelegate, CompanyForgetPasswordDelegate>
{
