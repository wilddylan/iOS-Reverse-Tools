...
@class EMGCDAsyncReadPacket, EMGCDAsyncSocketPreBuffer, EMGCDAsyncWritePacket, NSData, NSMutableArray, NSString;

@interface EMGCDAsyncSocket : NSObject
{
    unsigned int flags;
