...
#import "EMASIHTTPRequestDelegate.h"
#import "EMASIProgressDelegate.h"
#import "NSCopying.h"

@class NSDictionary, NSString;

@interface EMASINetworkQueue : NSOperationQueue <EMASIProgressDelegate, EMASIHTTPRequestDelegate, NSCopying>
{
    id delegate;
