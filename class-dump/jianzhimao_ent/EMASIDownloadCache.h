...
#import "EMASICacheDelegate.h"

@class NSRecursiveLock, NSString;

@interface EMASIDownloadCache : NSObject <EMASICacheDelegate>
{
...
@property(nonatomic) long long defaultCachePolicy; // @synthesize defaultCachePolicy;
