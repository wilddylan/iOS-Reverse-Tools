...
@interface PayCompositionViewController : BaseNavViewController <UITableViewDataSource, UITableViewDelegate>
{
    NSMutableArray *_totalArray;
    NSMutableArray *_surplusArray;
...
- (void)configDataSurplus;
- (void)configDataTotal;
- (void)configData;
