...
@interface LeaderForgetPasswordViewController : BaseNavViewController
{
    id <LeaderForgetPasswordDelegate> _delegate;
...
@property(nonatomic) __weak id <LeaderForgetPasswordDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
