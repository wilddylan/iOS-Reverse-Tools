...
@class EMASIDataDecompressor, NSArray, NSData, NSDate, NSDictionary, NSError, NSInputStream, NSMutableArray, NSMutableData, NSMutableDictionary, NSNumber, NSOutputStream, NSRecursiveLock, NSString, NSTimer, NSURL;
...
@interface EMASIHTTPRequest : NSOperation <NSCopying>
{
    ...
    NSURL *originalURL;
    NSURL *redirectURL;
    id <EMASIHTTPRequestDelegate> delegate;
    id <EMASIHTTPRequestDelegate><EMASIProgressDelegate> queue;
    ...
    id <EMASIProgressDelegate> uploadProgressDelegate;
    id <EMASIProgressDelegate> downloadProgressDelegate;
    ...
    NSString *proxyType;
    NSURL *PACurl;
    long long authenticationNeeded;
    ...
    NSTimer *statusTimer;
    id <EMASICacheDelegate> downloadCache;
    long long cachePolicy;
    long long cacheStoragePolicy;
    ...
    EMASIDataDecompressor *dataDecompressor;
...
+ (void)performInvocation:(id)arg1 onTarget:(id *)arg2 releEMASIngObject:(id)arg3;
...
+ (id)requestWithURL:(id)arg1 usingCache:(id)arg2 andCachePolicy:(long long)arg3;
...
@property(retain, nonatomic) EMASIHTTPRequest *PACFileRequest; // @synthesize PACFileRequest;
...
@property(retain) EMASIDataDecompressor *dataDecompressor; // @synthesize dataDecompressor;
...
@property long long cacheStoragePolicy; // @synthesize cacheStoragePolicy;
@property long long cachePolicy; // @synthesize cachePolicy;
@property id <EMASICacheDelegate> downloadCache; // @synthesize downloadCache;
...
@property long long authenticationNeeded; // @synthesize authenticationNeeded;
...
@property EMASIHTTPRequest *mainRequest; // @synthesize mainRequest;
...
- (void)addBEMASIcAuthenticationHeaderWithUsername:(id)arg1 andPassword:(id)arg2;
